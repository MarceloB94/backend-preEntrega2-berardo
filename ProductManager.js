...
class ProductManager {
  ...
  getProductById = async (id) => {
    try {
      ...
      console.error(
        `Error consultando el producto por ID: ${id}, detalle del error: ${error}`
      );
      throw Error(
        `Error consultando el producto por ID: ${id}, detalle del error: ${error}`
      );
  ...
  updateProduct = async (id, updatedFields) => {
    try {
      ...
      console.error(
        `Error actualizando el producto por ID: ${id}, detalle del error: ${error}`
      );
      throw Error(
        `Error actualizando el producto por ID: ${id}, detalle del error: ${error}`
      );
  ...
  deleteProduct = async (id) => {
    try {
      ...
      console.error(
        `Error eliminando el producto por ID: ${id}, detalle del error: ${error}`
      );
      throw Error(
        `Error eliminando el producto por ID: ${id}, detalle del error: ${error}`
      );
